...
<body>
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar z-depth-0">
      <a class="navbar-brand font-weight-bold" href="index.php">SheNiti</a>
      ...
      <div class="mask rgba-black-strong">
        <div class="container-fluid d-flex align-items-center justify-content-center h-100">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-md-10">
              <h1 class="white-text my-4 h1-responsive font-weight-bold" style="line-height: 1.5em;">
                Ministry of Women and Child Development
              </h1>
              <h4 class="white-text my-3">
                <em>SheNiti</em> – A student-driven initiative by <strong>Neha Pal</strong> (VIT Bhopal) to promote awareness and empowerment.
              </h4>
            </div>
          </div>
        </div>
