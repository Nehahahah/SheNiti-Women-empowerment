<?php include 'includes/header.php';?>
    ...
    <div class="col-12 text-center">
        <p style="font-size: 16px; font-weight: 500;">
            💻 This portal is a college-level project developed by <strong>Neha Pal</strong>, a Computer Science student at <strong>VIT Bhopal University</strong>, aiming to raise awareness and support for women empowerment through technology.
        </p>
        <p style="font-size: 14px;">
            🔗 <a href="mailto:11a.neha.pal@gmail.com">Contact Me</a> | <a href="https://github.com/nehaahen/women-empowerment" target="_blank">GitHub Project Link</a>
        </p>
    </div>
</div>
